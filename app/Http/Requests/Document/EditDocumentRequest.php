...
class EditDocumentRequest extends FormRequest
{
    ...
    {
        return [
            'id' => ['required', 'integer', 'exists:documents,id'], // Ensure the document exists
            'title' => ['required', 'string', 'max:255'],
            // 'url' is now optional (nullable) but still validated if present
            'url' => ['nullable', 'file', 'mimes:pdf,doc,docx,ppt,pptx,odt', 'max:10240'],
    ...
    {
        return [
            'id.required' => 'ID e dokumentit mungon.',
            'id.integer' => 'ID e dokumentit duhet të jetë një numër i plotë.',
